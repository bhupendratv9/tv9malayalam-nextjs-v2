...
export default function TopicListingPage({ pageData, queryParams = {} }) {
...
export async function getServerSideProps({ query }) {
  ...
  if (!topicSlug) return { notFound: true };

  return getPageProps(PAGE_IDS.TOPIC_LISTING, {
    query: { ...query, topicSlug, topic: topicSlug, category: "topic" },
  });
}
