...
export default function VideoDetailPage({ meta, sections, schemas, settings, siteSettings, queryParams = {}, pageDebug = null, articleMeta = null }) {
...
export async function getServerSideProps(context) {
  return getDetailServerSideProps(context, { pageId: PAGE_IDS.VIDEO_DETAIL });
}
