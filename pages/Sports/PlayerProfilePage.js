...
export default function PlayerProfilePage({ pageData, queryParams = {} }) {
...
export async function getServerSideProps({ query }) {
  const profileSlug = query?.profileSlug || "";
  if (!profileSlug) return { notFound: true };

  return getPageProps(PAGE_IDS.PLAYER_PROFILE, {
    query: { ...query, profileSlug },
  });
}
