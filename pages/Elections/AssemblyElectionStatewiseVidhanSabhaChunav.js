...
export default function AssemblyElectionStatewiseVidhanSabhaChunav({ pageData, queryParams = {} }) {
...
export async function getServerSideProps({ query }) {
  return getPageProps(PAGE_IDS.ASSEMBLY_ELECTION_VIDHAN_SABHA, { query });
}
