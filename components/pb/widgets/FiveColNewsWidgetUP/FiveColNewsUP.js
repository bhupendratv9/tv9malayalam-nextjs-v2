...
import styles from "./FiveColNewsUP.module.css";
...
export default function FiveColNewsWidgetUP({
  title = "",
  items = [],
  sectionUrl = "#",
  dataConfig = {},
  ...
  return (
    <div className={styles.businessHomepage_Widget}>
      ...
      <div className={styles.businessWidgetNews_Wrapper}>
        ...
        <div className={styles.smallNews_Wrapper}>
          {smallItems.map((item, idx) => {
            ...
            const showImage = idx < 2; // first 2 small items show image
