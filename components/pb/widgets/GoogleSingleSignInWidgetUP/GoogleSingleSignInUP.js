...
import styles from "./GoogleSingleSignInUP.module.css";

const LOCAL_STORAGE_KEY = "user";
const LOCAL_STORAGE_EXPIRY_KEY = "user_expiry";

export default function GoogleSingleSignInUP() {
  ...
  // Network sites for language switcher (from siteSettings or fallback)
  let networkSites = [];
  try {
  ...
  const logoUrl = siteSettings?.logo_url || TV9_NETWORK_LOGO;
