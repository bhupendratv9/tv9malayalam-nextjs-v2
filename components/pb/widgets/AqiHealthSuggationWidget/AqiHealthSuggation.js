...
import styles from "./AqiHealthSuggation.module.css";
...
export default function AqiHealthSuggationWidget({
  ...
  const cityLabel =
    getLocalizedCityName(aqiResponse || {}, cityLanguage) ||
    getLocalizedCityName(cityRecord || {}, cityLanguage) ||
  ...
  const headingTitle = `${cityLabel} ${titleSuffix}`;
  ...
  return (
    <div className={styles.healthAdvice_Wrapper}>
      <div className="container">
        <div className={styles.healthadvice}>
          <svg width={69} height={69}>
            <use href={`${ICONS_SVG}#facemask_icon`}></use>
          </svg>
        </div>

        <div className={styles.custom_heading}>
          <h2 className={styles.h1}>{headingTitle}</h2>
        </div>

        <div className={styles.dailyHealthWrap}>
          ...
          <div className={styles.healthWrap}>
            <div className={styles.healthupdate}>
              <figure>
                <div className={styles.numbers}>{cigarettesDay}</div>
                <div className={styles.text}>{perDayText}</div>
              </figure>
              <figure>
                <div className={styles.numbers}>{cigarettesWeek}</div>
                <div className={styles.text}>{weeklyText}</div>
              </figure>
              <figure>
                <div className={styles.numbers}>{cigarettesYear}</div>
                <div className={styles.text}>{yearlyText}</div>
              </figure>
            </div>
