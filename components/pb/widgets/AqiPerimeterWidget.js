...
export default function AqiPerimeterWidget({
  ...
  const nearbyCities = useMemo(
    () => normalizeNearbyCities(cityData?.nearby),
    [cityData]
  );
  ...
  return (
    <>
      <div className="AQIperimeterWrap">
        <div className="container">
          <div className="AQIperimeterReport">
            <div className="AQIHeading_Wrap">
              <h2 className="h1">{mainPollutantsTitle}</h2>
            </div>

            <div className="perimeterCard">
              {MAIN_POLLUTANTS.map((pollutant) => (
                <div className="airNumBx" key={pollutant.key}>
                  <div className={`airHead ${pollutant.headClass}`}>
          ...
          <div className="AQIperimeterReport">
            <div className="AQIHeading_Wrap">
              <h2 className="h1">{nearbyPollutedTitle}</h2>
            </div>
                  ...
                  {nearbyCities.length > 0 ? (
                    nearbyCities.map((row) => (
                      <tr key={row.id}>
                        ...
                        <td>{row.city}</td>
                        <td>
                          <span className={`aqi-${row.rank}`}>{row.aqi}</span>
                        </td>
                      </tr>
                    ))
                  ) : (
